    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{route('users.index')}}" class="nav-link">Users Info</a>
                </li>
            </ul>
            <!-- Right navbar links -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="" target="_blank" class="brand-link pl-5 bg-white">
                Banking System            
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy;<a href="">Banking System</a>.</strong>
            All rights reserved.
        </footer>
